...
img = bdsf.process_image(file, advanced_opts=True, interactive=True, thresh_pix=6., thresh_isl=4.5)
img.write_catalog(format='fits',catalog_type='srl', clobber=True)
img.write_catalog(format='ds9',catalog_type='gaul', clobber=True)
img.write_catalog(format='bbs',catalog_type='gaul', clobber=True)
