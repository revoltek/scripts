...
nchan= 0.5 # Channels per subband
bw=195.e3/nchan # Hz. 195kHz is the bandwidt of one subband
delta_T = 32. # seconds. Averaging
#b = 1292.0e3 # meters. IS longest baseline in meters. 
b = 60.0e3 # meters. RS longest baseline in meters.
delta_Theta = 0.5 # deg. Distance in image from phase centre, i.e. half the FWHM.
