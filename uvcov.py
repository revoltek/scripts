...
def main(options):
    ...
    ax.plot(xaxisvals0[tmpvals0!=badval], yaxisvals0[tmpvals0!=badval], ',k', alpha=0.2)
    ax.plot(xaxisvals1[tmpvals1!=badval], yaxisvals1[tmpvals1!=badval], ',r', alpha=0.2)
    ax.plot(xaxisvals2[tmpvals2!=badval], yaxisvals2[tmpvals2!=badval], ',b', alpha=0.2)
    ax.plot(xaxisvals3[tmpvals3!=badval], yaxisvals3[tmpvals3!=badval], ',g', alpha=0.2)
    ax.plot(xaxisvals4[tmpvals4!=badval], yaxisvals4[tmpvals4!=badval], ',y', alpha=0.2)
    ax.plot(xaxisvals5[tmpvals5!=badval], yaxisvals5[tmpvals5!=badval], ',c', alpha=0.2)
...
opt.add_option('-o','--output',help='Output filename [default uv.pdf]',default='uv.pdf')
