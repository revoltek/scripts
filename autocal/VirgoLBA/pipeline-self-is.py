...
model = '/home/fdg/scripts/autocal/VirgoA/150328_LBA-VirgoA-highres.model'
...
for ms in mss:
    ...
    check_rm(msout)
    s.add('NDPPP /home/fdg/scripts/autocal/VirgoA/parset_self-is/NDPPP-concatavg.parset msin.datacolumn=DATA msin='+ms+' msout='+msout, log=ms+'-init_avg.log', cmd_type='NDPPP')
s.run(check=True)
...
for ms in mss:
    s.add('calibrate-stand-alone --replace-sourcedb '+ms+' /home/fdg/scripts/autocal/VirgoA/parset_self-is/bbs-beam.parset '+fakeskymodel, \
...
for i in xrange(cycles):
    ...
    for ms in mss_c:
        s.add('NDPPP /home/fdg/scripts/autocal/VirgoA/parset_self-is/NDPPP-selfcal_modeldata.parset msin='+ms+' cal.parmdb='+ms+'/instrument'+' msin.blrange="['+str(blmin)+','+str(blmax)+']"', \
    ...
    if i%3 == 0:
        ...
        for ms in mss_c:
            s.add('NDPPP /home/fdg/scripts/autocal/VirgoA/parset_self-is/NDPPP-selfcor.parset msin='+ms+' cor.parmdb='+ms+'/instrument', \
        ...
        for ms in mss_c:
            s.add('NDPPP /home/fdg/scripts/autocal/VirgoA/parset_self-is/NDPPP-flag.parset msin='+ms, \
    ...
    s.run(check=False)
    s.add('losoto.py -v '+h5parm+' /home/fdg/scripts/autocal/VirgoA/parset_self-is/losoto.parset', log='losoto-c'+str(i)+'.log', log_append=True, cmd_type='python')
    s.run(check=False)
    ...
    logging.info('Concat...')
    check_rm('concat.MS*')
    s.add('NDPPP /home/fdg/scripts/autocal/VirgoA/parset_self-is/NDPPP-concat.parset msin="['+','.join(mss_c)+']" msout=concat.MS', \
