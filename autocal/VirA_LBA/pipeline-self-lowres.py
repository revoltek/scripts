...
#for ms in mss:
#    s.add('calibrate-stand-alone --replace-sourcedb '+ms+' /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/bbs-corbeam.parset '+fakeskymodel, \
...
for ms in mss:
    s.add('NDPPP /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/NDPPP-concatavg1.parset msin='+ms+'\
...
for ms in mss:
    s.add('NDPPP /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/NDPPP-selfcal_modeldata.parset msin='+ms+' cal.parmdb='+ms+'/instrument', \
...
s.run(check=False)
s.add('losoto.py -v '+h5parm+' /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/losoto.parset', log='losoto.log', log_append=True, cmd_type='python')
s.run(check=False)
...
for ms in mss:
    s.add('NDPPP /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/NDPPP-selfcor.parset msin='+ms+' cor.parmdb='+ms+'/instrument', \
...
s.add('NDPPP /home/fdg/scripts/autocal/VirA_LBA/parset_self-lowres/NDPPP-concatavg2.parset msin="['+','.join(mss)+']" msout=concat-avg.MS avg.freqstep=1 avg.timestep=4', \
