...
run_losoto('fr', mss, ['losoto-flag.parset','losoto-fr.parset'], outtab='rotationmeasure000', \
...
for ms in mss:
    s.add('BLsmooth.py -r -f 0.5 -i CORRECTED_DATA -o SMOOTHED_DATA '+ms, log=ms+'_smooth3.log', cmd_type='python')
s.run(check=True)
